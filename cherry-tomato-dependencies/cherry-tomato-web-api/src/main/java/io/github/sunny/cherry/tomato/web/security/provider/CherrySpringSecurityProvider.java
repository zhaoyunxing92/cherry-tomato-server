 ...
 */
package io.github.sunny.cherry.tomato.web.security.provider;
 ...
 */
@Service("cherrySpringSecurityProvider")
public class CherrySpringSecurityProvider implements AuthenticationProvider {
    private final UserDetailsService authUserDetailService;

    public CherrySpringSecurityProvider(UserDetailsService authUserDetailService) {this.authUserDetailService = authUserDetailService;}
